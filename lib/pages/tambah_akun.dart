...
class _TambahAkunState extends State<TambahAkun> {
  final _formKeyTambahAkun = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          if (_formKeyTambahAkun.currentState!.validate()) {
            ...
            globals.akun.add(globals.DataAkunObject(
                idAkun: globals.akun.length + 1,
                namaAkun: namaakun.text,
                iconAkun: iconakun as IconData,
                saldoAkun: saldoint,
                idJenisAkun: globals.jenisakunSelected));
